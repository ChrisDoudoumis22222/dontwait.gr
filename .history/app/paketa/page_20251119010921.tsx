...
export default function PackagesComparisonPage() {
  ...
  const getPriceText = (plan: "basic" | "pro") => {
    ...
    const yearly = baseMonthly * 10; // 2 months free
    return `€${yearly} / έτος`;
  };
        ...
        <main className="pt-20 pb-10">
          ...
          <section className="max-w-6xl mx-auto px-4 mb-4">
            <div className="flex flex-col items-center gap-2">
              <div className="flex items-center gap-3 bg-white/70 backdrop-blur rounded-full px-4 py-2 shadow-sm border border-blue-100">
                <span
                ...
                <button
                  ...
                  className={`relative inline-flex h-7 w-16 items-center rounded-full border transition-colors duration-200 ${
              ...
              {billingPeriod === "yearly" && (
                <p className="text-[11px] sm:text-xs text-emerald-600 font-medium mt-1 text-center">
                  Με ετήσια χρέωση κερδίζετε 2 μήνες δωρεάν (πληρώνετε 10,
                  χρησιμοποιείτε 12).
                </p>
              )}
            </div>
