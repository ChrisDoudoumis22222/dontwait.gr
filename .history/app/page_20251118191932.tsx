...
const TestimonialCard: React.FC<{ t: Testimonial; index: number }> = ({
  ...
  <motion.div
    ...
    className="group relative rounded-2xl bg-white/95 backdrop-blur-sm p-6 md:p-7 shadow-md ring-1 ring-slate-100 hover:shadow-2xl hover:-translate-y-1.5 transition-all"
  >
  ...
  return (
    <div id={id} className={className}>
      ...
      <section className="relative isolate py-20 md:py-28 overflow-hidden">
        {/* background with soft blue “bands” */}
        <div className="absolute inset-0 -z-20 bg-gradient-to-b from-[#e6f1ff] via-white to-[#e6f1ff]" />
        <Wave position="top" className="text-[#d0e3ff]" />
        <Wave position="bottom" className="text-[#d0e3ff]" />

        {/* decorative blue lines */}
        <div className="pointer-events-none absolute inset-x-0 top-10 md:top-14 -z-10 flex justify-center">
          <div className="h-[3px] w-[80%] max-w-5xl rounded-full bg-gradient-to-r from-transparent via-[#c4ddff] to-transparent" />
        </div>
        <div className="pointer-events-none absolute inset-x-0 bottom-10 md:bottom-14 -z-10 flex justify-center">
          <div className="h-[3px] w-[80%] max-w-5xl rounded-full bg-gradient-to-r from-transparent via-[#c4ddff] to-transparent" />
        </div>

        <div className="mx-auto max-w-6xl px-4 md:px-6 relative z-10">
          {/* main white “card” container */}
          <div className="bg-white/98 backdrop-blur-md rounded-[32px] shadow-[0_25px_80px_rgba(15,23,42,0.10)] ring-1 ring-[#e2ecff] px-4 py-8 md:px-10 md:py-12 lg:px-16">
            <div className="mb-10 md:mb-12 text-center">
              ...
              {subtitle && (
                <motion.p
                  ...
                  className="mt-3 text-sm md:text-base text-slate-500 max-w-2xl mx-auto"
                >
                  {subtitle}
                </motion.p>
              )}
