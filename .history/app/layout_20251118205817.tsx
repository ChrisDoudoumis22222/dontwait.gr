...
import "./style/globals.css"; // <- this should include tailwind base/components/utilities
  ...
  return (
    <html lang="el">
      <body className="bg-white text-gray-900 antialiased">
        {/* NAVBAR LIMIT WRAPPER */}
        <header className="w-full border-b border-blue-100 bg-gradient-to-r from-white via-blue-50 to-white shadow-sm">
          <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
            {/* Here your Navbar component will render */}
            {/* Example: <Navbar onTrialOpen={() => {}} /> */}
          </div>
        </header>
