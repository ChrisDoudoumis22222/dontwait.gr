              ...
              <div key={index} className="h-full">
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    <Link href="/paketa" className="block">
                      <Button
                        type="button"
                        className="inline-flex items-center justify-center rounded-full text-xs md:text-sm font-semibold w-full h-10 bg-white border border-slate-300 hover:bg-slate-50 text-slate-700"
                      >
                        Δες το πακέτο αναλυτικά
                      </Button>
                    </Link>
                  </div>
