...
interface PricingPlan {
  name: string;
  monthlyPrice?: number; // basic & pro
  customPriceText?: string; // enterprise
  features: string[];
...
export default function PricingCards({ onPlanSelect }: PricingCardsProps) {
  ...
  const formatPrice = (plan: PricingPlan) => {
    ...
    // yearly → 2 μήνες δώρο = πληρώνει 10 μήνες
    ...
    <section className="bg-gradient-to-b from-slate-50 via-white to-slate-100 py-24 md:py-32">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center mb-10">
          <div className="inline-flex items-center bg-slate-100 rounded-full p-1 gap-1 shadow-sm">
            <button
              type="button"
            ...
            <button
              ...
              className={`px-4 py-1.5 text-xs md:text-sm rounded-full font-medium flex items-center gap-1 transition-all ${
            ...
            return (
              ...
              >
                ...
                <div className="mt-4 mb-6 space-y-1">
                  ...
                  {discountNote && billingPeriod === "yearly" && plan.monthlyPrice && (
