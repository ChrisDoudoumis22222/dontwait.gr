...
// Inline DontWait logo component
const InlineLogo: React.FC<{ className?: string; size?: "sm" | "lg" }> = ({
  className,
  size = "sm",
}) => {
  const height = size === "lg" ? 48 : 32;
  const width = size === "lg" ? 180 : 120;
  const imgClass = size === "lg" ? "h-12 w-auto" : "h-8 w-auto";
  ...
  return (
    ...
    >
      <Image
        src="/2025-02-10-203844.svg" // ⬅️ from /public
        alt="DontWait logo"
        width={width}
        height={height}
        className={imgClass}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="mb-12 text-center">
          <h2 className="mt-0 text-3xl md:text-4xl lg:text-5xl font-bold text-blue-900">
            Ξεκινήστε με το <InlineLogo size="lg" /> σε 3 απλά βήματα
          </h2>
