...
const HowItWorksSection: React.FC = () => {
  ...
  const displayedStep = activeStep === 0 ? 1 : activeStep;
    ...
    <section className="relative bg-gradient-to-b from-blue-50 via-white to-blue-50/60 py-20 md:py-28">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="mb-12 text-center">
          <span className="inline-flex items-center justify-center rounded-full bg-blue-100 text-blue-700 text-xs font-semibold px-4 py-1 uppercase tracking-[0.18em]">
            Πώς Λειτουργεί
          </span>
          <h2 className="mt-4 text-3xl md:text-4xl lg:text-5xl font-bold text-blue-900">
            Ξεκινήστε με το DontWait.gr σε 3 απλά βήματα
          </h2>
        ...
        <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-16 max-w-6xl mx-auto">
              ...
              >
                ...
                <div className="pt-3">
                  ...
                  <p className="text-gray-700 leading-relaxed text-sm md:text-base">
                    Δημιουργείτε λογαριασμό στο{" "}
                    <span className="font-semibold">DontWait.gr</span>, προσθέτετε
                    τα στοιχεία της επιχείρησης, τις υπηρεσίες και τις ώρες
                    λειτουργίας σας.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div className="pt-3">
                  ...
                  <p className="text-gray-700 leading-relaxed text-sm md:text-base">
                    ...
                    <span className="font-semibold">προσωπική σας σελίδα
                    κρατήσεων</span>. Μοιραστείτε τον σύνδεσμο με πελάτες ή
                    συνδέστε το δικό σας domain.
                  </p>
                </div>
              </div>
          ...
          <div className="w-full lg:flex-1">
              ...
              <div className="absolute bottom-5 left-5 right-5 flex items-center justify-between text-white text-sm md:text-base">
                <div>
                  ...
                  <p className="font-semibold">
                    {displayedStep === 1 &&
                      "Ρύθμιση επιχείρησης στο DontWait.gr"}
                    {displayedStep === 2 &&
            ...
            <p className="mt-4 text-xs md:text-sm text-slate-500 text-center max-w-md mx-auto">
              Οι εικόνες είναι ενδεικτικές και δείχνουν πώς μπορείτε να
              χρησιμοποιήσετε το DontWait.gr στην καθημερινή λειτουργία της
              επιχείρησής σας.
            </p>
          </div>
        </div>
