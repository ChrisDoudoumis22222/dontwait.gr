...
import { Wand2, Share2, LineChart } from "lucide-react";
...
const HOW_IT_WORKS_STEPS: Step[] = [
  {
    ...
    imageQuery:
      "minimal modern workspace desk setup clean aesthetic professional",
    icon: Wand2,
  },
  {
    number: "02",
              ...
              >
                ...
                >
                  <div className="relative h-56 bg-gradient-to-br from-neutral-100 to-neutral-50 overflow-hidden">
                    <Image
                      src={`/.jpg?height=400&width=500&query=${encodeURIComponent(
                        step.imageQuery
                      )}`}
                      alt={step.title}
                      fill
