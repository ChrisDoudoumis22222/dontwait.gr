...
// small helper so we don't repeat the logo JSX
const InlineLogo: React.FC<{ className?: string }> = ({ className }) => (
  <span className={`inline-flex align-middle items-center mx-1 ${className ?? ""}`}>
    <Image
      src="http://localhost:3000/_next/image?url=https%3A%2F%2Fi.ibb.co%2FDPmSsDrN%2F2025-02-10-203844.png&w=384&q=75"
      alt="DontWait logo"
      width={120}
      height={32}
  ...
  return (
    <section className="relative bg-gradient-to-b from-blue-50 via-white to-blue-50/60 py-20 md:py-28">
      ...
      <div className="container mx-auto px-4 relative z-10">
        {/* Title area, WITHOUT "Πώς Λειτουργεί" pill */}
        <div className="mb-12 text-center">
          <h2 className="mt-0 text-3xl md:text-4xl lg:text-5xl font-bold text-blue-900">
            Ξεκινήστε με το <InlineLogo /> σε 3 απλά βήματα
          </h2>
              ...
              <div className="absolute bottom-5 left-5 right-5 flex items-center justify-between text-white text-sm md:text-base">
                <div>
                  ...
                  <p className="font-semibold">
                    {displayedStep === 1 && (
                      <>
                        Ρύθμιση επιχείρησης στο <InlineLogo className="mx-0" />
                      </>
                    )}
                    {displayedStep === 2 &&
