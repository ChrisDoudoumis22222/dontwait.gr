...
// 👉 uses /images/2025-02-10-203844.svg from app/public/images/...
const InlineLogo: React.FC<{ className?: string; size?: "sm" | "lg" }> = ({
  ...
  const imgClass =
    size === "lg"
      ? "h-14 w-auto md:h-16" // bigger in title
      : "h-8 w-auto";
  ...
  return (
    ...
    >
      <img
        src="G:\dontwait.gr-main\app\public\images\2025-02-10-203844.svg"
        alt="DontWait logo"
        className={imgClass}
      />
    </span>
