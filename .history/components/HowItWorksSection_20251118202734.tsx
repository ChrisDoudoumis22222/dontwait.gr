    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            {/* HEADER – BLUE TOP WITH LOGO + PROGRESS */}
            <div className="bg-blue-700 text-white px-6 pt-5 pb-4 relative">
              {/* Close button */}
              <button
                type="button"
                onClick={onClose}
                disabled={isSubmitting}
                className="absolute top-4 right-4 text-white/80 hover:text-white transition-colors z-10 hover:rotate-90 duration-300"
              >
                <X className="h-5 w-5" />
              </button>
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <div className="w-full max-w-xs mx-auto">
                        ...
                        <div key={s} className="flex items-center">
                          ...
                          <motion.div
                            ...
                            animate={{
                              ...
                              color: isActive || isCompleted ? "#0f172a" : "#e5e7eb",
                              boxShadow:
                          ...
                          {/* Connector */}
                          {s < 3 && (
                            <div className="h-1 w-10 md:w-14 rounded-full bg-white/20 overflow-hidden mx-1">
                              <motion.div
                                initial={false}
                                animate={{
                                  scaleX: step > s ? 1 : step === s ? 0.6 : 0,
                                }}
                                transition={{ duration: 0.25 }}
                  ...
                  <p className="text-[11px] text-center text-white/80 mt-1">
                    Βήμα {step} από 3
                  </p>
                </div>
              </div>
                ...
                {step === 1 && (
                  ...
                  >
                    ...
                    <motion.select
                      ...
                      className="w-full border-2 border-gray-200 p-3 rounded-lg mb-6 focus:border-blue-500 focus:outline-none transition-colors bg-white"
                    >
                    ...
                    <div className="flex justify-end gap-3">
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="px-6 py-2.5 border-2 border-gray-200 rounded-lg font-medium hover:bg-gray-50 transition-colors text-gray-700"
                      >
                        Ακύρωση
                      </motion.button>
                      <motion.button
                ...
                {step === 2 && (
                  ...
                  >
                    ...
                    <motion.input
                      ...
                      disabled={isSubmitting}
                      whileFocus={{ scale: 1.01 }}
                      className="w-full border-2 border-gray-200 p-3 rounded-lg mb-4 focus:border-blue-500 focus:outline-none transition-colors bg-white"
                    />
                    <motion.input
                      type="email"
                      name="email"
                ...
                {step === 3 && (
                  ...
                  >
                    ...
                    <motion.textarea
                      ...
                      className="w-full border-2 border-gray-200 p-3 rounded-lg mb-6 focus:border-blue-500 focus:outline-none transition-colors resize-none bg-white"
                    />
