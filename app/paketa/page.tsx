// app/paketa/page.tsx  (or app/packages/page.tsx)
"use client";
...
// Colors / Loader
// ---------------------------------------------
const DONTWAIT_BLUE = "#1e40af"; // dark blue used across the UI

const PackagesPageLoader: React.FC = () => {
  return (
...
export default function PackagesComparisonPage() {
  ...
  // 🔄 first-visit loader for this page (stays a bit longer)
  useEffect(() => {
    const t = setTimeout(() => setShowLoader(false), 1600); // ~1.6s
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-blue-100 text-gray-900 font-sans">
        ...
        <main className="pt-20 pb-10">
            ...
            <div className="flex flex-col gap-4 sm:gap-5 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-3 mt-4">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-full bg-blue-600 text-white text-xs sm:text-sm font-medium px-4 py-2 shadow-md hover:bg-blue-700 transition-colors"
                >
          ...
          <section
            id="packages-section"
            className="max-w-6xl mx-auto px-4 mb-10 sm:mb-14 grid gap-5 md:grid-cols-3"
          >
            {/* BASIC */}
